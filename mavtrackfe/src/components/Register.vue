  ...
  <div class="container-fluid">
    <div class="row align-items-center justify-content-center">
      <div class="col col-12 col-sm-6 col-md-10 col-lg-6">
        <div class="card">
          <div class="card-header" style="color: rgba(230, 43, 70, 1);">Please Register</div>
            ...
            <form v-else ref="form">
              <div class="container-fuild">
                ...
                <div class="row justify-content-around">
                  ...
                  <div type="button" class="btn btn-danger col-4" @click="register">Register</div>
                </div>
              </div>
            </form>
          </div>
